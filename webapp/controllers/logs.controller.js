        ...
        $scope.showLog = function (name) {
            ...
            if(name == 'daemon') {
                ...
                $http({
                    ...
                    $scope.log = false;
                    alert('Error during log opening. Possibly miner-metrics not started. If so, just wait for application to start (or jump into Docker and watch logs by yourself).');
                })
            }
            return;
        }
